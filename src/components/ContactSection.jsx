        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-primary-50 to-white p-8 md:p-12 rounded-2xl shadow-xl border border-primary-100">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className={`${social.color} text-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col items-center justify-center space-y-3 group`}
                >
            ...
            <div className="mt-12 grid md:grid-cols-2 gap-6">
              <div className="flex items-start space-x-4 p-4 bg-white rounded-lg border border-primary-100">
              ...
              <div className="flex items-start space-x-4 p-4 bg-white rounded-lg border border-primary-100">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Online e Presencial</p>
                  <p className="text-gray-600 text-sm">Região e demais localidades</p>
                </div>
              </div>
            </div>
          </div>
