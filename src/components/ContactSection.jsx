        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="font-body text-grafite/55 dark:text-white/45 mt-6 max-w-2xl mx-auto">
              Tire suas dúvidas ou chame no WhatsApp para conversar sobre vistorias, inspeções e laudos técnicos.
            </p>
          </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-5 relative z-10">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  id={social.trackingId}
                  onClick={social.name === 'WhatsApp' ? () => trackWhatsAppClick(social.trackingId) : undefined}
