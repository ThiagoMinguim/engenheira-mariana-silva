export default function ContactSection() {
  const socialLinks = [
    ...
    },
    {
      ...
      url: 'https://www.instagram.com/eng.mariananasilva/',
    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Card de Contato */}
          <div className="bg-gradient-to-br from-primary-50 to-white p-8 md:p-12 rounded-2xl shadow-xl border border-primary-100">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className={`${social.color} text-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 flex flex-col items-center justify-center space-y-3 group`}
                >
            ...
            <div className="mt-12 grid md:grid-cols-2 gap-6">
              <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-14 h-14 bg-gradient-to-br from-primary-800 to-primary-900 rounded-xl flex items-center justify-center flex-shrink-0 shadow-md transform transition-all duration-300 hover:scale-105">
              ...
              <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div>
                  <h4 className="font-bold text-gray-800 mb-1">Atendimento</h4>
                  <p className="text-gray-600 text-sm">Uberaba e região</p>
                </div>
              </div>
            </div>
          </div>
