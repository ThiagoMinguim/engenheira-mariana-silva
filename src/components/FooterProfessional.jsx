        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#contact" className="text-sm hover:text-primary-400 transition-colors">
                  Contato
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a
                  href="https://www.instagram.com/eng.mariananasilva/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm hover:text-primary-400 transition-colors"
                >
              ...
              <div className="flex items-center space-x-3">
                ...
                <a
                  href="https://www.tiktok.com/@mariannaslv2?_r=1&_t=ZS-94RelBtN5n6"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm hover:text-primary-400 transition-colors"
                >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="text-center">
            <p className="text-sm text-gray-400">
              © {currentYear} Engenheira Mariana Silva. Todos os direitos reservados.
            </p>
