...
export default function WhyInvestSection() {
  ...
  return (
    <section id="investir" className="relative overflow-hidden bg-[#FAFBF8] px-6 py-24 text-[#2E3238]">
      {/* Background decorativo */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-24 bottom-0 h-[520px] w-[520px] rounded-full border border-[#A8CBB0]/20" />
        <div className="absolute -left-10 bottom-16 h-[360px] w-[360px] rounded-full border border-[#A8CBB0]/20" />
        <div className="absolute right-0 top-0 h-72 w-72 rounded-full border border-[#A8CBB0]/20" />

        {/* Architectural perspective sketch */}
        <svg
          className="absolute left-0 bottom-0 h-[400px] w-[440px] opacity-[0.10]"
          viewBox="0 0 440 400"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          {/* Perspective vanishing guides */}
          ...
          {/* Main building — side face (perspective) */}
          ...
          {/* Windows — front face (3 columns, multiple rows) */}
          {/* Col 1 */}
          ...
          {/* Side windows (perspective — parallelogram hints) */}
          ...
          {/* Secondary shorter building behind */}
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-14 lg:grid-cols-[0.8fr_1.5fr]">
        ...
        <div className="flex flex-col justify-center">
          <div className="mb-6 flex items-center gap-3">
            ...
            <span className="text-sm font-semibold uppercase tracking-[0.32em] text-[#2F6F4E]">
              Investimento inteligente
            </span>
          </div>

          <h2 className="max-w-md font-serif text-5xl leading-tight text-[#252A31] md:text-6xl">
            Por que{" "}
              ...
              <article
                ...
                className={[
                  ...
                  isActive
                    ...
                    : "border-[#DDE5DE] bg-white/75 shadow-sm",
                ].join(" ")}
              >
                ...
                {/* City skyline silhouette on hover */}
                <svg
                ...
                <div className="relative z-10">
                  ...
                  <h3
                    className={[
                      ...
                      isActive ? "text-white" : "text-[#252A31]",
                    ].join(" ")}
                  >
                    {item.title}
                  </h3>
                  ...
                  <div
                    className={[
                      ...
                      isActive ? "bg-white/70" : "bg-[#A8CBB0]",
                    ].join(" ")}
                  />
                  ...
                  <p
                    className={[
                      ...
                      isActive ? "text-white/90" : "text-[#697077]",
                    ].join(" ")}
                  >
                    {item.description}
                  </p>
                ...
                <div className={`absolute bottom-6 right-6 grid grid-cols-4 gap-1 transition-opacity duration-500 ${isActive ? 'opacity-0' : 'opacity-30'}`}>
