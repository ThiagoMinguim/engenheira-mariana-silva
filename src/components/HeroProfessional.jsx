...
export default function HeroProfessional() {
  ...
  return (
    <section id="home" className="relative pt-[75px] overflow-hidden">
      ...
      <div className="absolute top-60 left-[-8%] w-[350px] h-[350px] bg-verde-200/50 dark:bg-verde-800/20 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-25 dark:opacity-15 animate-blob-delayed" />
      <div className="absolute bottom-40 right-[20%] w-[300px] h-[300px] bg-verde-light/20 dark:bg-verde-700/15 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-25 dark:opacity-15 animate-blob-slow" />
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center py-16 md:py-24 lg:py-28">
          ...
          <div className="space-y-8">
            ...
            <motion.p
              ...
              className="font-body text-lg text-grafite/65 dark:text-white/60 leading-relaxed max-w-lg"
            >
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-5 -left-5 bg-white dark:bg-grafite rounded-xl shadow-xl shadow-grafite/10 dark:shadow-black/30 px-5 py-3 z-20 animate-float-slow"
            >
